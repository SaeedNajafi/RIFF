...
%The experiments were conducted using multiple NVIDIA's A40 and RTX6000 GPU cards (upto 60 GPU cards). This was facilitated by the GPU cluster provided by the Vector Institute\footnote{\url{https://vectorinstitute.ai/}}.
...
\begin{center}
\includesvg[width=0.5\textwidth]{images/mml_vs_pg_off_policy.svg}
\end{center}
